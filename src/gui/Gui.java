...
public class Gui extends javax.swing.JFrame {
    ...
    // ChartPanel used to display this chart in a swing gui
     ...
     * @param n 
     */
    public void UpdateNumSamples(int n)
    {
        jLabelNumSamples.setText(Integer.toString(n));
    }
     ...
     * @return 
     */
    public int GetKeyByteIndexToAttack()
    {
        if (jToggleButtonK0.isSelected())
           return 0;
        else if (jToggleButtonK1.isSelected())
           return 1;
        else if (jToggleButtonK2.isSelected())
           return 2;
        else if (jToggleButtonK3.isSelected())
           return 3;
        else if (jToggleButtonK4.isSelected())
           return 4;
        else if (jToggleButtonK5.isSelected())
           return 5;
        else if (jToggleButtonK6.isSelected())
           return 6;
        else if (jToggleButtonK7.isSelected())
           return 7;
        else if (jToggleButtonK8.isSelected())
           return 8;
        else if (jToggleButtonK9.isSelected())
           return 9;
        else if (jToggleButtonK10.isSelected())
           return 10;
        else if (jToggleButtonK11.isSelected())
           return 11;
        else if (jToggleButtonK12.isSelected())
           return 12;
        else if (jToggleButtonK13.isSelected())
           return 13;
        else if (jToggleButtonK14.isSelected())
           return 14;
        else
           return 15;
    }
    ...
    public void PlotResults()
    {
        ...
        for (int i = 0; i < dpaData.size(); i++)
        {
            data.add(i, dpaData.get(i));
        }
        DefaultXYDataset dxydata = new DefaultXYDataset();
        ...
        // Put our chart into our gui
        jPanelResults.add(chartPanel, BorderLayout.CENTER);
        jPanelResults.validate();
    ...
    private void initComponents() {
        ...
        jLabelNumSamples = new javax.swing.JLabel();
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jButtonGetRoundKeys, javax.swing.GroupLayout.DEFAULT_SIZE, 146, Short.MAX_VALUE)
                    .addComponent(jButtonLoadData, javax.swing.GroupLayout.DEFAULT_SIZE, 146, Short.MAX_VALUE)
                    .addComponent(jButtonDpa, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 146, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        jLabel16.setText("Num Samples:");

        jLabelNumSamples.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabelNumSamples.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabelNumSamples.setText("-----");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jLabelNumSamples, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jTabbedPaneResults.addTab("Config", jPanel1);
        ...
        jTabbedPaneResults.addTab("Round Keys", jPanel3);
        ...
        jTabbedPaneResults.addTab("Results", jPanel6);
    ...
    private javax.swing.JLabel jLabelNumSamples;
